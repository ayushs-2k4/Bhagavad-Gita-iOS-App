...
struct OtherExplanationView: View {
    let author: String
    var sc: String? = nil
    var ht: String? = nil
    var hc: String? = nil
...
#Preview {
    NavigationStack {
        OtherExplanationView(author: "Swami Tejomayananda", et: "1.1 Dhritarashtra said  What did my people and the sons of Pandu do when they had assembled\ntogether eager for battle on the holy plain of Kurukshetra, O Sanjaya.",
